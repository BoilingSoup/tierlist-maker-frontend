...
export const useChangePasswordMutation = (form: ReturnType<typeof useChangePasswordForm>) => {
  const theme = useMantineTheme();

  return useMutation((values: ChangePasswordFormValues) => attemptChangePassword(values), {
    onSuccess: () => {
      form.reset();
    ...
    onError: (e: AxiosError<{ message: string }>) => {
      ...
      if (errorReceived !== undefined && incorrectPasswordErrMsg.test(errorReceived)) {
